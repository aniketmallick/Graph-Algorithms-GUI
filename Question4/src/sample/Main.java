...
//        this.importGraph("input.txt");
    ...
    public void importGraph(String stri) throws FileException {
        String[] str;
        try
        {   BufferedReader br = new BufferedReader(new FileReader("C:\\Users\\Asus\\IdeaProjects\\Question4\\src\\sample\\"+stri));
    ...
    public void exportGraph(String stri) throws FileException {
        ...
        try(BufferedWriter br = new BufferedWriter(new FileWriter("C:\\Users\\Asus\\IdeaProjects\\Question4\\src\\sample\\"+stri)))
        {
            String str="";
...
public class Main extends Application {
    ...
    String path="C:\\Users\\Asus\\IdeaProjects\\Question4\\src\\sample\\";
    String nullable="";
...
//        Parent root = FXMLLoader.load(getClass().getResource("sample.fxml"));
        ...
        Button b=new Button("Get Dijkstra Path");
...
//                newWindow.setHeight(500);
                ...
                try {
                    ...
                    int i = -1, j = -1;
                    i = graph.retIndex(fromT.getText());
                    j = graph.retIndex(toT.getText());
                    if(i != -1 && j != -1)
...
//                        circle  .getPoints().addAll(new Double[] {t.getStartX(),t.getStartY(),t.getEndX(),t.getEndY()});

                        //Setting Colour and Stroke properties for the polygon
                        circle.setCenterX(t.getStartX());circle.setCenterY(t.getStartY());
...
//                        pathTransition.setDuration(Duration.millis(2000));
                    ...
                    if(circle.getLayoutX()==0 && circle.getLayoutY()==0 && cost==0){
                        circle.setLayoutX(vertexList.get(i).getX());
                        circle.setLayoutY(vertexList.get(i).getY());
                        circle.setFill(Color.DARKRED);
                        circle.setStroke(Color.RED);
                    }
                    pathTransition.play();
                    root3.getChildren().addAll(circle);
                    HBox h1 = new HBox();
                    Label temp =new Label("Dijkstra's Path Cost is = " + cost);
                    ...
                    alert.setTitle("");
                    alert.setContentText("No dijkstra path possible between these vertices");
                    alert.show();
//                    e.printStackTrace();
                }
            }
